...
export default function PersonalizedGreeting({ greeting, streak }: Props) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0D1B2A] via-[#0D1B2A] to-[#1CE7D0]/10 border border-white/5 p-6">
      {/* Decorative elements */}
      ...
      <div className="relative flex items-center gap-4">
        {/* AI Brain icon */}
        <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-[#FFC857]/20 to-[#1CE7D0]/20 flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(255,200,87,0.1)]">
